...
import { userProfile, teamMembers, tasksCache } from '../state.js';
import { formatDate, debounce } from '../utils/dateUtils.js';
import { getFilteredTasksFromCache, renderCurrentView } from '../utils/UIUtils.js';
import { createChart } from './DashboardView.js'; // Reuse createChart
import { STATUS_CHART_COLORS, PRIORITY_COLORS } from '../state.js';
...
export function setReportDateRange(rangeKey) {
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center mb-6">
                ...
                <div class="p-4 bg-green-50 rounded-lg">
                 ...
                 <div class="p-4 bg-yellow-50 rounded-lg">
                    <p class="text-2xl font-bold text-yellow-600">${completedTasks} / ${totalTasks}</p>
                    <p class="text-sm text-gray-600">Hoàn thành / Tổng</p>
                </div>
            </div>
...
async function exportReportToPDF() {
    ...
    const fontBase64 = 'AAEAAAASAQAABAAgR0RFRqZDpEwAAAOUAAACWEdQT1MH0tr...'; // Note: In real code, add the full base64 for Roboto font or use a different approach
